...
import "./hatha.css"; // CSS for the component
  ...
  const yogas = [
    {
      ...
      name: "Dhanurasana",
      description: "Enhancing flexibility and strengthening the back muscles.",
      duration: "2 minutes",
      videoUrl: "https://www.youtube.com/embed/4P2mYcOGxbU"
    },
    {
      id: 2,
      image: "/Setu Bandhasana.jpg",
      name: "Setu Bandhasana",
      description: "Strengthen the back and improve spinal flexibility.",
      duration: "1 minutes",
      videoUrl:    "https://www.youtube.com/embed/BYr5Dz2yLsc"
    },
    {
      id: 3,
      image: "/Halasana.jpg",
      name: "Halasana",
      description: "Stimulate the abdominal organs and improve digestion.",
      duration: "3 minutes",
      videoUrl:  "https://www.youtube.com/embed/qpuY0jXimtQ"
    },
    {
      id: 4,
      image: "/Kakasana.jpg",
      name: "Kakasana",
      description: "Strengthen the arms, wrists while enhancing balance and coordination.",
      duration: "6 minutes",
      videoUrl:  "https://www.youtube.com/embed/2uBjpDLf8bw"
    },
  ];
